...
from build_model_training import build_init_pcure_model
...
# parser.add_argument('data', nargs='?', metavar='DIR', const='cifar',
#                     help='path to dataset (positional is *deprecated*, use --data-dir)')
parser.add_argument('--gpu', default=3, type=str,
                    help='gpu')
group.add_argument('--data-dir', metavar='DIR',default="",
...
group.add_argument('--dataset-trust-remote-code', action='store_true', default=True,
...
def main():
    ...
    #     **args.model_kwargs,
    # )
    model = build_init_pcure_model(args)
    ...
    if args.dataset=='gtsrb':
        dataset_train = datasets.GTSRB(root=args.data_dir, split=args.train_split, download=True)
        args.num_classes = 43
    elif args.dataset == 'cifar':
        dataset_train = datasets.CIFAR10(root=args.data_dir, train=True, download=True)
        args.num_classes = 10
    elif args.dataset == 'cifar100':
        dataset_train = datasets.CIFAR100(root=args.data_dir, train=True, download=True)
        args.num_classes = 100
    elif args.dataset == 'flowers102':
        dataset_train = datasets.Flowers102(root=args.data_dir, split=args.train_split, download=True)
        args.num_classes = 102
    # elif args.dataset=='imagenette':
    #     dataset_train = datasets.Imagenette(root=args.data_dir, split=args.train_split, download=True)
    #     args.num_classes = 10
    else:
    ...
    if args.val_split:
        if args.dataset == 'gtsrb':
            dataset_eval = datasets.GTSRB(root=args.data_dir, split="test", download=True)
        elif args.dataset == 'cifar':
            dataset_eval = datasets.CIFAR10(root=args.data_dir, train=False, download=True)
        elif args.dataset == 'cifar100':
            dataset_eval = datasets.CIFAR100(root=args.data_dir, train=False, download=True)
        elif args.dataset == 'flowers102':
            dataset_eval = datasets.Flowers102(root=args.data_dir, split="val", download=True)
        # elif args.dataset == 'imagenette':
        #     dataset_train = datasets.Imagenette(root=args.data_dir, split="val", download=True)
        #     args.num_classes = 10
        else:
