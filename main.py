...
# from prediction_map_analysis import prediction_label_produce_original_pc_debugging

parser = argparse.ArgumentParser()


parser.add_argument("--model-dir",default='',type=str,help="checkpoints directory")
...
parser.add_argument("--model",default='vitsrf14x1_split6_masked',type=str,help="model name; see checkpoints/readme.md for more details")
# parser.add_argument("--model",default='bagnet33_masked_cifar',type=str,help="model name; see checkpoints/readme.md for more details")

parser.add_argument("--patch-size",default=16,type=int,help="size of the adversarial patch")
...
with torch.no_grad():
	...
	for data,labels in tqdm(val_loader):
		...
		if args.certify:
			...
			results, pred_map, original_pres = model.certify(data,labels)
			for map in pred_map:
